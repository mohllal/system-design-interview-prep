...
Returned access token directly in URL fragment. Avoid for new apps; replaced by Authorization Code + PKCE.

### Resource Owner Password Credentials (legacy)

Client collects username/password directly. Only acceptable for highly trusted first-party migration scenarios, not third-party integrations.

## Scopes and Least Privilege

Scopes limit token power.
